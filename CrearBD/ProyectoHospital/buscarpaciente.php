...
$resultado_busquedaSP = mysqli_query($conexion, "CALL getPacientes") or die("ERROR EN EL QUERY: " . mysqli_error());
						...
						<div id="middlePart">
								...
								<div id="middleTwoColumn">
										<div class="h1title">
												...
												<span>Por favor llena los datos del paciente para iniciar la búsqueda</span>
										</div>
                                	...
                                	<table class="tableBlue">
                                                ...
                                                <?php 
													  if (isset($resultado_busquedaSP)) {
        													...
        													"	
															<tr>
																<td><a href=\"opciones_paciente.php?IDPac=".$row['IDPac']."\">".$row['IDPac'] ."</a></td>
