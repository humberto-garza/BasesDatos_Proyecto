...
$resultado_busquedaSP = mysqli_query($conexion, "CALL StoreProcSelectEmployee") or die("ERROR EN EL QUERY: " . mysqli_error());
                                	...
                                	<table class="tableBlue">
                                                ...
                                                <?php 
													  if (isset($resultado_busquedaSP)) {
        													...
        													"	
															<tr>
																<td><a href=\"editar_entidad.php?ssn=".$row['Ssn']."\">".$row['Ssn'] ."</a></td>
																<td>".$row['FName'] ."</td>
																<td>".$row['MInit'] ."</td>
                                                                <td>".$row['LName'] ."</td>
																<td>".$row['Addres'] ."</td>
